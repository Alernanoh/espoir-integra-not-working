...
class DropdownEntidadesFinancierasWidget extends ConsumerWidget {
  const DropdownEntidadesFinancierasWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DropdownSearch<String>(
      ...
      items: providerCueRec.bancos,
      selectedItem: providerCueRec.bancoName,
      ...
      onChanged: (String? value) async =>
          ref.read(actualizarClienteCuentaRecuperacionProvider.notifier).onChangeEntidadesFinancieras(
                value ?? '',
